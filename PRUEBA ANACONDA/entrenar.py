...
##pre procesamiento de imagenes del entrenamiento
...
##cnn.compile(loss='categorical_cross entropy', optimizer=optimizers.Adam(lr=lr), metrics=['accuracy'])
cnn.compile(loss='categorical_cross entropy', optimizer='adam', metrics=['accuracy'])
...
##Guardar modelo generado de entrenamiento
dir = './modelo/'
